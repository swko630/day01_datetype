...
CREATE TABLE STUDENT_T(
 ...
 STUDENT_NAME VARCHAR2(100BYTE) NOT NULL,
 ...
 SUBJECT_NAME VARCHAR2(100BYTE) NOT NULL
 );
 --수강신청 테이블
 CREATE TABLE ENROLL_T (
 ENROLL_NO NUMBER NOT NULL PRIMARY KEY,
 STUDENT_NO NUMBER REFERENCES STUDENT_T(STUDENT_NO) ON DELETE CASCADE, --학생이 지워지면 수강신청도 지워짐
 SUBJECT_NO NUMBER REFERENCES SUBJECT_T(SUBJECT_NO) ON DELETE SET NULL --과목이 지워지면 수강신청에서 과목번호만 바꾼다
 );
